...
class Testboss(Enemy): # fork of the enemy class to make a boss (if you want to make a boss use this class)
    ...
    def __init__(self, game, pos=(190, 400), time=0, behavior=None, behavior_args=[]):
        ...
        self.spellcards = [Spellcard(self.game, 5, self.game.diff, self), Spellcard01(self.game, 5, self.game.diff, self)] # spell lists (if no registies used)
        self.attorder = [self.nonspells[1], self.spellcards[1], self.nonspells[0], self.spellcards[0]] # attack order
