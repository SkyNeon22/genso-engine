...
class YingYang:
    def __init__(self, game, player, pos=(0, 0)):
        ...
        self.img = pg.image.load("sprites/other/ying_reimu.png")
...
class YingYangMarisaA(YingYang):
    def __init__(self, game, player, pos=(0, 0)):
        ...
        self.img = pg.image.load("sprites/other/ying_marisa.png")
...
class YingYangSanaeA(YingYang):
    def __init__(self, game, player, pos=(0, 0)):
        ...
        self.img = pg.image.load("sprites/other/ying_sanae.png")
