...
class Bar:
    def __init__(self, game, pos=(0, 0), size=35, color=(255, 255, 255), text="", textsize=30):
        pg.font.init()
        self.font = pg.font.SysFont('Comic Sans MS', textsize)
        self.game = game
        self.pos = list(pos)
    ...
    def draw(self):
        pg.draw.rect(self.drawsurf, self.bar_color, [self.pos[0], self.pos[1], self.bar_len, self.size])
        self.draw_text()
...
class PopUpText(Text):
    def __init__(self, game, pos=(0, 0), size=30, color=(255, 255, 255), text="", speed=-2, maxlifetime=50):
...
class Selectable_Text:
    def __init__(self, game, pos=(0, 0), color=(160, 160, 160), select_color=(255, 255, 255), text="", on_use=None, is_selectable=True, args=None, size=30):
        pg.font.init()
