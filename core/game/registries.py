...
class PROJECTILE_REGISTRY(REGISTRY):
    def __init__(self, game):
        ...
        self.rglist: dict = {"ball_gray": (self.game, [5, 55], [16, 16], projectile.MoveInDirection, [], [6, 6]),
                             ...
                             "big_ball_gray": (self.game,(8, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_red": (self.game,(39, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_blue": (self.game,(103, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_yellow": (self.game,(199, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_green": (self.game,(167, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_pink": (self.game,(71, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_light_blue": (self.game,(135, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),
                             "big_ball_white": (self.game,(231, 308), [28, 28], projectile.MoveInDirection, [], [15, 15]),}
 
    def shoot(self, proj: str,pos: list, angle: int = 0, speed: float = 3.0):
        '''Shoots a projectile from the registry'''
        self.game.proj_list.append(projectile.NewFormatProjectile(self.rglist.get(proj)[0], pos, angle=angle, speed=speed, marginxy=self.rglist.get(proj)[1], htsize=self.rglist.get(proj)[5], size=self.rglist.get(proj)[2] ))
...
class MUSIC_REGISTRY(REGISTRY):
    def __init__(self, game):
        super().__init__(game)
        self.rglist: dict = {-1: sfx.Music(self.game, "assets/sfx/music/Heart-Stirring Urban Legends.mp3"),
                             0: sfx.Music(self.game, "assets/sfx/music/Electric Heritage.mp3"),
