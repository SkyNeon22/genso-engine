...
class Spellcard01(Spellcard):
    ...
    def do(self):
        ...
        self.counter += 1
        if self.counter % 2 == 0:
            self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 2.4)
...
class Spellcard02(Spellcard):
    ...
    def do(self):
        ...
        self.counter += 1
        if self.counter % 4 == 0:
            self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 3.4)
...
class Spellcard03(Spellcard):
    ...
    def do(self):
        ...
        if self.counter % 4 == 0:
           self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 3.4)
           self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 3.9)

class Spellcard04(Spellcard):
    def __init__(self, game, rank, difficulty=None, inflictor=None):
        super().__init__(game, rank, difficulty, inflictor) 
        self.shoot_time = 15
        self.counter = 0
    ...
    def do(self):
        self.game.projregistry.shoot("big_ball_light_blue", [random.randint(0, 384), 0], [0, 1], random.randint(20, 200) / 120)
        self.game.projregistry.shoot("big_ball_blue", [random.randint(0, 384), 0], [0, 1], random.randint(20, 200) / 120)
        self.counter += 1
        if self.counter % 4 == 0:
            self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 2.4)
            self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 3.6)
            self.game.projregistry.testshoot("ball_green", self.inflictor.hitbox.center, get_angle(self.game.player.hitbox.center, self.inflictor.hitbox.center), 4.4)