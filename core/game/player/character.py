...
class Player:
    def __init__(self, game, pos=(194, 300), start_power=0.0):
        ...
        self.hitboxsize = [10, 10]
        self.hitbox = pg.Rect(self.pos[0] + 13, self.pos[1] + 17, self.hitboxsize[0], self.hitboxsize[1])
    ...
    def update(self):
        ...
        self.hitbox.center = self.graze_hitbox.center
...
class ReimuA(Player):
    def __init__(self, game, pos=(190, 400), start_power=0.0):
        ...
        self.unfocus_speed = 2.47
        self.focus_speed = 1.43
...
class ReimuB(Player):
    def __init__(self, game, pos=(190, 400), start_power=0.0):
        ...
        self.yin_offset_p_3 = [38, -30, -45, -30, -2, -40]
        self.yin_offset_p_4 = [28, -30, -30, -30, 48, 0, -55, 0]
...
class MarisaA(Player):
    def __init__(self, game, pos=(190, 400), start_power=0.0):
        ...
        self.size = (29, 43)
        self.speed = 0.85
        self.focus_speed = 1.88
        self.unfocus_speed = 3.39
        self.homing_cooldown = 0.35
        self.shot_type = MarisaShotNormal
        self.secondary = MarisaRocketNormal
        self.right = pg.image.load("assets/img/sprites/characters/Marisa/MarisaRight.png")
        self.left = pg.image.load("assets/img/sprites/characters/Marisa/MarisaLeft.png")
        self.other = pg.image.load("assets/img/sprites/characters/Marisa/Marisa.png")
...
class SanaeA(Player):
    def __init__(self, game, pos=(190, 400), start_power=0.0):
        ...
        self.speed = 2.0
        self.size = [37, 49]
        self.focus_speed = 1.72
        self.unfocus_speed = 2.54
        self.homing_cooldown = 0.5
        self.right = pg.image.load("assets/img/sprites/characters/Sanae/SanaeRight.png")
        self.left = pg.image.load("assets/img/sprites/characters/Sanae/SanaeLeft.png")
        self.other = pg.image.load("assets/img/sprites/characters/Sanae/Sanae.png")
        self.homing_shot_cooldown = 0.7
        self.homing_cooldown = 0.0
